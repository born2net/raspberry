...
function runMotor(leftMotor, rightMotor, direction) {
    ...
    // enable here if you wish to use the RRB2 hat
    //runMotorRRB2(leftMotor,rightMotor,direction);

    // enable here if you wish to use the Adafruit Motor HAT
    runMotorADA(leftMotor,rightMotor,direction);
}
...
/**
 ...
 @param {direction} String
 **/
function runMotorRRB2(leftMotor, rightMotor, direction) {
    ...
    log('RBB2 direction ' + direction + ' leftMotor ' + leftMotor + ' rightMotor ' + rightMotor, 1);
...
/**
 ...
 @param {direction} String
 **/
function runMotorADA(leftMotor, rightMotor, direction) {
    leftMotor = Math.abs(fixDec(leftMotor));
    rightMotor = Math.abs(fixDec(rightMotor));
