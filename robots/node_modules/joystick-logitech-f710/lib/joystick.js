...
Joystick.prototype.handleSticks = function (byte5, byte6, byte8) {
    ...
    } else if (byte8 === "06" || byte8 === "07") {
        this.handleCrossMovement(byte5, byte6, byte8);
    }
};
...
Joystick.prototype.handleCrossMovement = function (byte5, byte6, byte7) {
    if (byte5 === "01" && byte6 === "80" && byte7 === "07") {
        this.crossEvent = "button:crossup:press";
        this.emit(this.crossEvent);
    } else if (byte5 === "ff" && byte6 === "7f" && byte7 === "07") {
        this.crossEvent = "button:crossdown:press";
        this.emit(this.crossEvent);
    } else if (byte5 === "01" && byte6 === "80" && byte7 === "06") {
        this.crossEvent = "button:crossleft:press";
        this.emit(this.crossEvent);
    } else if (byte5 === "ff" && byte6 === "7f" && byte7 === "06") {
        this.crossEvent = "button:crossright:press";
        this.emit(this.crossEvent);
    } else if (byte5 === "00") {
        this.emit(this.crossEvent + ':up');
