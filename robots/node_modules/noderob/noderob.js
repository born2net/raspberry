 ...
 **/
exports.createNodeRob = function (i_config) {
...
exports.createComBroker = function () {
    var EventEmitter = require("events").EventEmitter;
    var ee = new EventEmitter();
    commBroker = new ComBroker(ee);
    return commBroker;
};

function ComBroker(ee) {
    this.m_ee = ee;
    this.m_services = {};
}
...
ComBroker.prototype = {
    ...
    setValue: function (i_name, i_value, i_fireEvent) {
        ...
        var val1 = this.m_services;
        var val2 = this.m_services.length;
        if (i_fireEvent)
    ...
    fire: function (i_event, i_data) {
        var self = this;
        self.m_ee.emit(i_event, i_data);
    },

    listen: function (event, func) {
        var self = this;
        self.m_ee.on(event, function (e) {
            func(e)
        });
    },
