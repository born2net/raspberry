...
var NodeRob = function(i_config) {
    ...
    self.on('custom_event', function() {
        self.logSomething('custom_event');
    });
    self.logSomething('init');
...
NodeRob.prototype.logSomething = function(something) {
    console.log(something);
    this.emit('ABC','dome data');
};
...
NodeRob.prototype.setLCD = function (lcdValue, lcdColor) {
    var self = this;
