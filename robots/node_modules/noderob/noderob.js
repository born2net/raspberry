...
NodeRob.prototype.doSomething = function () {
    var self = this;
...
NodeRob.prototype._controlDifferentialMotors = function () {
    var self = this;
    var reduceX;
    var sharp = false;
    ...
    if (self.m_leftMotor >= 0 && self.m_rightMotor >= 0) {
        self.m_leftMotor = (self.m_leftMotor * 0.25) + 50;
        self.m_rightMotor = (self.m_rightMotor * 0.25) + 50;
    }
    if (self.m_leftMotor <= 0 && self.m_rightMotor <= 0) {
        self.m_leftMotor = 50 + self.m_leftMotor * 0.25;
        self.m_rightMotor = 50 + self.m_rightMotor * 0.25;
    }
    ...
    //self.m_leftMotor = Math.round(self._perc(self.m_leftMotor, 25) * 100);
    //self.m_rightMotor = Math.round(self._perc(self.m_rightMotor, 25) * 100);
};
