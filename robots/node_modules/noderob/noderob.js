...
noderob.prototype = {
    ...
    setModel: function (i_model) {
        var self = this;
        self.m_model = i_model;
    },
    ...
    initJoystick: function () {
        var self = this;
        if (self.m_model == -1) {
            self.log('no model selected', 0, 'red');
            process.exit();
        }
        ...
        Joystick.create("/dev/input/js0", function (err, joystick) {
            ...
            switch (self.m_model) {
                ...
                case self.MODEL_THREE:
                {
                }
                case self.MODEL_SMART:
                {
                }
                case self.MODEL_TRIANGLE:
                {
                }
            }
        });
